...
public class Director {
	...
	public Director(String nombre, String apellidos, String pseudonimo, Calendar fecha_nacimiento, int participaciones,
			boolean activo, String[] premios, Calendar fecha_muerte) {
	...
	public Director(String nombre, String apellidos, Calendar fecha_nacimiento, int participaciones, boolean activo,
